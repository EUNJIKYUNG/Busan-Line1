...
class CManualOperationHandler : public CivetHandler
{
public:
	...
	bool handleGet(CivetServer *server, struct mg_connection *conn)
	{
		...
		mg_printf(conn,
			...
			"                </span>\r\n"
			"                <span id=\"headerTitle\">\xec\x88\x98\xeb\x8f\x99\xec\x9a\xb4\xed\x96\x89""</span>\r\n"
			"                <hr id=\"headerLine\">\r\n"
			"            </header>\r\n"
			"    \r\n"
			"            <!-- section -------------------------------------------------------------- -->\r\n"
			...
			"                    connection = new WebSocket(wsproto + '//' + window.location.host + '/wsManualOperation');\r\n"
