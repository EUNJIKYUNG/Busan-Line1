...
public:
	...
	bool handleGet(CivetServer *server, struct mg_connection *conn)
	{
		...
		mg_printf(conn,	
			...
			"            <section>\r\n"
			"                <div id=\"stat\">\r\n"
			"                    <p style=\"background-color:rgb(0, 211, 28);\">OK</p>\r\n"
			"                    <p style=\"background-color:red;\">NG</p>\r\n"
			"                </div>\r\n"
			...
			"                    <button id=\"CAR_0\" onclick=\"location.href='detailedDiagnosis?car=7'\">8\xed\x98\xb8\xec\xb0\xa8""</button>\r\n"
			"                </div>\r\n"
			"               \r\n"
			"            </section>\r\n"
			"            \r\n"
