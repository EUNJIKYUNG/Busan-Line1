...
class CSimulationHandle : public CivetHandler
{
public:
	...
	bool handleGet(CivetServer *server, struct mg_connection *conn)
	{
		...
		mg_printf(conn, GetCSSPages::pSimulation);
		mg_printf(conn,
			"    </style>\r\n"
			"        <title>PISC-\xeb\xaa\xa8\xec\x9d\x98\xec\xa3\xbc\xed\x96\x89""</title>\r\n"
			"\r\n"
			"    </head>\r\n"
			"\r\n"
			...
			"                </span>\r\n"
			"                <span id=\"headerTitle\">\xeb\xaa\xa8\xec\x9d\x98\xec\xa3\xbc\xed\x96\x89""</span>\r\n"
			"                <hr id=\"headerLine\">\r\n"
			"            </header>\r\n"
			"    \r\n"
			"            <!-- section -------------------------------------------------------------- -->\r\n"
			...
			// "                    <tr><td><img src=\"/app/image/UpScroll.png\" alt=\"UP\xeb\xb2\x84\xed\x8a\xbc""\" onclick=\"clickLineUpDn('up', mRouteTableId)\" style=\"width:80px\"></td></tr>\r\n"
			...
			// "                    <tr><td><img src=\"/app/image/DownScroll.png\" alt=\"Down\xeb\xb2\x84\xed\x8a\xbc""\" onclick=\"clickLineUpDn('down', mRouteTableId)\" style=\"width:80px\"></td></tr>\r\n"
			...
			// "                </table>\r\n"
            "               <table class=\"updnBtn\">"
            "                   <tr><td><button class=\"upBtn\" onclick=\"clickLineUpDn('up', mRouteTableId)\"></button></td></tr>\r\n"
            "                   <tr><td style=\"height: 60px;\"></td></tr>\r\n"
            "                   <tr><td><button class=\"downBtn\" onclick=\"clickLineUpDn('down', mRouteTableId)\"></button></td></tr>\r\n"
            "               </table>\r\n"
			"    \r\n"
			"    \r\n"
			"                <!-- \xeb\xb0\xa9\xec\x86\xa1"" \xeb\xaa\xa9\xeb\xa1\x9d"" : \xed\x85\x8c\xec\x9d\xb4\xeb\xb8\x94"" -->\r\n"
			"                <table class=\"inforTable\" id=\"eventList\">\r\n"
			...
			// "                <table class=\"arrowBtn\">\r\n"
			// "                    <tr><td><img src=\"/app/image/UpScroll.png\" alt=\"UP\xeb\xb2\x84\xed\x8a\xbc""\" onclick=\"clickLineUpDn('up', nEventTableId)\" style=\"width:80px\"></td></tr>\r\n"
			// "                    <tr><td style=\"height: 60px;\"></td></tr> <!-- Up/Down \xeb\xb2\x84\xed\x8a\xbc"" \xec\x82\xac\xec\x9d\xb4\xec\x97\x90"" \xea\xb3\xb5\xeb\xb0\xb1"" -->\r\n"
			// "                    <tr><td><img src=\"/app/image/DownScroll.png\" alt=\"UP\xeb\xb2\x84\xed\x8a\xbc""\" onclick=\"clickLineUpDn('down', nEventTableId)\" style=\"width:80px\"></td></tr>\r\n"
			// "                </table>\r\n"
            "               <table class=\"updnBtn\">"
            "                   <tr><td><button class=\"upBtn\" onclick=\"clickLineUpDn('up', nEventTableId)\"></button></td></tr>\r\n"
            "                   <tr><td style=\"height: 60px;\"></td></tr>\r\n"
            "                   <tr><td><button class=\"downBtn\" onclick=\"clickLineUpDn('down', nEventTableId)\"></button></td></tr>\r\n"
            "               </table>\r\n"
			"    \r\n"
			"            </section>\r\n"
			"    \r\n"
			...
			"                <button class=\"roundFootBtn\" id=\"stopBtn\" onclick=\"sendCommand('stop',0)\">\xec\xa0\x95\xec\xa7\x80""</button>\r\n"
			"                <button class=\"roundFootBtn\" id=\"startBtn\" onclick=\"sendCommand('start',0)\">\xec\x8b\x9c\xec\x9e\x91""</button>\r\n"
			"            </footer>\r\n"
			"    \r\n"
			"        </div>\r\n"
			...
			"            var mIgnoreInput = 0;\r\n"
			"            var mLineType = 0;\r\n"
			"            var mRouteTableId = document.getElementById(\"routeList\");\r\n"
			"            var nEventTableId = document.getElementById(\"eventList\"); \r\n"
			"    \r\n"
			"            var mLineData = {\r\n"
			"                \"type\": \"none\",\r\n"
			"                \"count\": 0,\r\n"
			...
			"             { \"name\": \"eventList\", \"element\": document.getElementById(\"eventList\"), \"querySelector\": \"#eventList tr\", \"selectedLine\": undefined, \"scrollPos\": 0, \"listData\": mLineData },\r\n"
			"            ]\r\n"
			"    \r\n"
			"    \r\n"
			"            function scanList(arrList) {\r\n"
			"                var line = document.querySelectorAll(arrList.querySelector);\r\n"
            "                console.log(\"scanList(\"+arrList+\")\");\r\n"
            ...
            "                console.log(\"sendSelected(\"+socId + \",\" + socData + \")\");\r\n"
			...
			"                var strInfo = JSON.stringify(info);\r\n"
            "                console.log(\"confirmSelected(\"+socId+\")\");\r\n"
			"                connection.send(strInfo);\r\n"
			"                if (socId == \"routeList\") {\r\n"
			"                    resetScrollPos();\r\n"
			"                }\r\n"
			...
			"                {\r\n"
			"                   \r\n"
			"                    var index = arrControl.findIndex(i => i.name == \"eventList\");\r\n"
			"                    console.log(index);\r\n"
			...
			"                    connection = new WebSocket(wsproto + '//' + window.location.host + '/wsSimulation');\r\n"
